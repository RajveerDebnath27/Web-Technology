		...
		<fieldset>
            ...
            <h2 align="center"></h2><br />
    				...
    				<div class="input-group">
     				...
     				<input type="text" name="search_text" id="search_text" placeholder="Search by Seller Name Details" class="form-control" autocomplete="off" /><br />
    				</div>
    				</div>
    				<br />
   <div id="result"></div>
