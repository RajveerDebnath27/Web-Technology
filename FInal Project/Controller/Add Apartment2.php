...
<head>
	...
	<title>Add Apartment For Rent</title>
...
<div class="container" align="center" style="width: 600px;">
	<form style="text-align: center;" method="post" action="<?php echo ($_SERVER['PHP_SELF']);?>" novalidate>
		<center>
		<fieldset>
			<center><legend><h2>Add Apartment For Rent</h2></legend></center>
...
if ($_SERVER['REQUEST_METHOD'] === "POST") {                 
   function test_input() {
    ...
    if($conn->connect_error){
        ...
        $stmt = $conn->prepare("INSERT INTO rent (ID, Name, Price, email, phone, Location, apartment) values(?, ?, ?, ?, ?, ?, ?)");
